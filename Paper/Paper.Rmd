...
```{r CumRet,  warning =  FALSE, fig.align = 'center', fig.cap = "Cumulative Returns per Sector for ALSI and SWIX \\label{CumRet}", fig.ext = 'png', fig.height = 4, fig.width = 7}
...
```{r ALSI, warning =  FALSE, fig.align = 'center', fig.cap = "ALSI Weight Contribution \\label{ALSI}", fig.height = 4, fig.width = 7, dev = 'png'}
weights_plot(T40, "ALSI")
```


```{r SWIX, warning =  FALSE, fig.align = 'center', fig.cap = "SWIX Weight Contribution \\label{SWIX}", fig.height = 4, fig.width = 7, dev = 'png'}
weights_plot(T40, "SWIX")
```


```{r LogRet,  warning =  FALSE, fig.align = 'center', fig.cap = "Log Returns per Sector for the SWIX \\label{LogRet}", fig.ext = 'png', fig.height = 4, fig.width = 7}
...
```{r DCCfullr,  warning =  FALSE, fig.align = 'center', fig.cap = "Dynamic Conditional Correlations: Resources \\label{DCCfullr}", fig.ext = 'png', fig.height = 4, fig.width = 7}
...
```{r DCCfullf,  warning =  FALSE, fig.align = 'center', fig.cap = "Dynamic Conditional Correlations: Financials \\label{DCCfullf}", fig.ext = 'png', fig.height = 4, fig.width = 7}
...
```{r DCCfulli,  warning =  FALSE, fig.align = 'center', fig.cap = "Dynamic Conditional Correlations: Industrials \\label{DCCfulli}", fig.ext = 'png', fig.height = 4, fig.width = 7}
